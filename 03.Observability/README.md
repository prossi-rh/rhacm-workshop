...
```
<hub> $ oc apply -f https://raw.githubusercontent.com/prossi-rh/rhacm-workshop/master/03.Observability/exercise/multiclusterobservability.yaml -n open-cluster-management-observability
```
